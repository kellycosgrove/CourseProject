...
def query_results():
    ...
    first_song, first_art, second_song, second_art, third_song, third_art, fourth_song, fourth_art = main(text)
    processed_text = text.upper()
    return render_template('pop_punk_gui_results.html', first_song=first_song, first_art=first_art, 
